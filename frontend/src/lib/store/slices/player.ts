...
> = (set, get) => ({
  ...
  setCurrentPlayer: (player) => {
    ...
    }), false, 'player/set-current-player');
  },
  ...
  updateCurrentPlayer: async (updates) => {
    ...
    try {
      ...
      }), false, 'player/update-current-player');
  ...
  fetchPlayers: async (params = {}) => {
    ...
    }), false, 'player/fetch-players/start');
    ...
    try {
      ...
      }), false, 'player/fetch-players/success');
      ...
      }), false, 'player/fetch-players/error');
  ...
  searchPlayers: async (query) => {
    set(produce((state: RootState) => {
      ...
      state.player.allPlayers.loading = true;
      state.player.allPlayers.error = null;
    }), false, 'player/search-players/start');
    ...
    try {
      ...
      set(produce((state: RootState) => {
        ...
        state.player.allPlayers.loading = false;
        state.player.allPlayers.lastUpdated = Date.now();
      }), false, 'player/search-players/success');
      ...
      set(produce((state: RootState) => {
        state.player.allPlayers.loading = false;
        state.player.allPlayers.error = errorMessage;
      }), false, 'player/search-players/error');
  ...
  fetchPlayerPreferences: async (playerId) => {
    try {
      ...
      }), false, 'player/fetch-preferences/success');
  ...
  updatePlayerPreferences: async (playerId, preferences) => {
    try {
      ...
      }), false, 'player/update-preferences/success');
  ...
  clearSelectedPlayers: () => {
    ...
    }), false, 'player/clear-selected-players');
  },
