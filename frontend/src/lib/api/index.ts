...
export { getPreferences, updatePreferences, getCompatibility } from './endpoints/preferences';

// ==================================================
// HEALTH ENDPOINTS
// ==================================================

export { healthCheck, databaseHealthCheck } from './endpoints/health';

// ==================================================
// UTILITY EXPORTS
// ==================================================

export { buildUrl, generateRequestId, DEFAULT_TIMEOUT, DEFAULT_RETRY_CONFIG } from '../utils/http';
