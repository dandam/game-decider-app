          ...
          <Stack spacing="xl">
            <section>
              ...
              <p className="text-lg text-surface-700 mb-6">
                Game Night Concierge helps you organize perfect game nights by matching players with
                games based on preferences, group size, and play time. Explore our demo pages to see
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Database validation tool with real-time statistics, player profiles, and
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-surface-600">
                    Our algorithm considers player preferences, group size, available time, and game
                    complexity to suggest the perfect games for your group.
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold mb-2">Player Profiles</h3>
                  <p className="text-surface-600">
                    Track individual preferences, play history, and favorite games to improve
                ...
                <div>
                  ...
                  <p className="text-surface-600">
                    Browse and filter through an extensive collection of board games with detailed
                ...
                <div>
                  ...
                  <p className="text-surface-600">
                    Plan your game nights in advance with scheduling tools and automatic game
                    suggestions based on attendees.
                  </p>
                </div>
              </div>
            </section>
