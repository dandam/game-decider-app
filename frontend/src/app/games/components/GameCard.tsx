    ...
    <Card className={cardClasses} onClick={handleClick}>
      <CardContent className="p-4">
        ...
        {game.players_who_played && game.players_who_played.length > 0 && (
          <div className="mb-3">
            <div className="flex items-center text-xs text-surface-600 dark:text-surface-400 mb-1">
              <svg
            ...
            <div className="flex flex-wrap gap-1">
              {game.players_who_played.map(player => (
                <Badge key={player} variant="outline" size="sm" className="text-xs bg-purple-50 text-purple-700 border-purple-200 dark:bg-purple-900/20 dark:text-purple-300 dark:border-purple-700">
                  {player}
                </Badge>
              ))}
            </div>
